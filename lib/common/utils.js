...
/**
 * Returns the visibility timeout given a duration, and a max duration.
 * @param  {Number} duration The duration for the visibility timeout
 * @param  {Number} maxDuration The max duration of the visibility timeout
 * @return {Number} visibilityTimeout The visiibility timeout duration
 */
function getVisibilityTimeout(duration, maxDuration) {
